(() => {
    ...
    function initSliders() {
        if (document.querySelector(".testimonials__slider")) new swiper_core_Swiper(".testimonials__slider", {
            ...
            navigation: {
                prevEl: ".testimonials__arow--left",
                nextEl: ".testimonials__arow--right"
            },
            on: {}
        });
    }
    ...
    function animationHeader() {
        if (window.pageYOffset) headerBottom.classList.add("header-color"); else headerBottom.classList.remove("header-color");
    }
